package cn.peterzhen.iosalertdialog;
 ...
 * @date 2019/1/8 22:37
 */
public class IOSAlertDialog extends AppCompatDialog implements DialogInterface {
    ...
    protected IOSAlertDialog(@NonNull Context context) {
        this(context, 0);
    }
     ...
     * to get the dialog's style (such as {@link android.support.v7.appcompat.R.attr#alertDialogTheme}.
     */
    protected IOSAlertDialog(@NonNull Context context, @StyleRes int themeResId) {
        super(context, resolveDialogTheme(context, themeResId));
        mAlert = new AlertController(getContext(), this, getWindow());
    }

    protected IOSAlertDialog(@NonNull Context context, boolean cancelable,
    ...
    public static class Builder {
        ...
        public IOSAlertDialog create() {
            ...
            final IOSAlertDialog dialog = new IOSAlertDialog(P.mContext, mTheme);
        ...
        /**
         * Creates an {@link IOSAlertDialog} with the arguments supplied to this
